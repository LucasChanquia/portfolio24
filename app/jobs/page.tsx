  ...
  return (
    <>
      <div className=" pb-[20px] border-b border-b-violet-700  w-full md:max-w-[80%] m-auto">
        ...
        <span className="flex gap-3 items-center text-[16px]"><i className="fi fi-sr-undo text-[16px] text-gray-500"></i>Volver</span>
        </Button>
        </div>
        ...
        <article className="w-full grid sm:grid-cols-2">
          {jobs.map(
            ({
              ...
              return (
                <>
                  <div key={index} className="bg-slate-800 rounded-md p-5 m-2 gap-2">
